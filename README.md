...
- Contains the TestAmenityDocs class:
...
- Contains the TestCityDocs class:
...
- Contains the TestPlaceDoc class:
...
- Contains the TestReviewDocs class:
...
- Contains the TestStateDocs class:
